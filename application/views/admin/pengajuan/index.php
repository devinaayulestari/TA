            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header text-center">
                        <h4 class="card-title">DAFTAR PENGAJUAN BERKAS</h4>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="<?= base_url('admin/detail_pendaftar/').$data['data_id']?>">Lihat Detail</a>
                                                <a class="dropdown-item" href="<?= base_url('admin/hapus/').$data['data_id']?>">Hapus</a>
                                            </div>
                                        </div>
                                    </td>
                                    </tr>
